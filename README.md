...
Used the python flask framework to create a CRUD api which can store data in key/value pairs in memory itself and a client in which fetches the values from it.
